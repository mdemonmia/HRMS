...
- Name: vendorAgreement.spec.js >> test vendor agreement page >> check delete vendor agreement @functional @regression
- Location: tests\vendorAgreement.spec.js:212:8
...
Call log:
  - waiting for locator('text=Do you want to delete this?') to be visible
...
```ts
  ...
  72  |         const cmodal = this.page.locator('text=Do you want to delete this?');
