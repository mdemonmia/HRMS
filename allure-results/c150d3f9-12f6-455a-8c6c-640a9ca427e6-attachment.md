...
Call log:
  - waiting for locator('#vndrAddDiv')
    - locator resolved to <select required="" id="vndrAddDiv" name="vndrAddDiv" formcontrolname="vndrAddDiv" _ngcontent-ng-cli-universal-c373924197="" class="form-control form-select ng-untouched ng-pristine ng-valid">…</select>
...
> 33 |         if(vform.div !=='')await this.Division.selectOption(vform.div.trim().toLowerCase());
     |                                                ^ TimeoutError: locator.selectOption: Timeout 60000ms exceeded.
