...
- Name: user.spec.js >> test user management page >> checked org division with invalid data
- Location: tests\user.spec.js:77:10
...
Call log:
  - waiting for locator('//select[@formcontrolname=\'userDepartmentId\']')
    - locator resolved to <select formcontrolname="userDepartmentId" aria-label="Default select example" _ngcontent-ng-cli-universal-c4118926259="" class="form-control form-select ng-untouched ng-pristine ng-valid">…</select>
