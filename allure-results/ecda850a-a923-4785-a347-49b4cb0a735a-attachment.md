...
- Name: vendorInfo.spec.js >> test vendor info page >> check blank vendor code name @functional @regresstion
- Location: tests\vendorInfo.spec.js:50:10
...
Call log:
  - waiting for locator('.toast-message') to be visible
...
```ts
  ...
  52 | 
  53 |         const errorMsg = await this.page.locator('.toast-message');
