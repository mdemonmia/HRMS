...
- Name: vendorAgreement.spec.js >> test vendor agreement page >> check Edit file name vendor agreement @functional @regression
- Location: tests\vendorAgreement.spec.js:153:8
...
Call log:
  - waiting for locator('tr').filter({ hasText: 'ArenaBD' }).locator(locator('.fa.fa-edit'))
