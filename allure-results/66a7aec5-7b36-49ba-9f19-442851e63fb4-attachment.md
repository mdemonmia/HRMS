...
Call log:
  - waiting for locator('//select[@formcontrolname=\'positionId\']')
    - locator resolved to <select formcontrolname="positionId" aria-label="Default select example" _ngcontent-ng-cli-universal-c2531119888="" class="form-control form-select ng-untouched ng-pristine ng-valid">…</select>
  - attempting select option action
    ...
    - retrying select option action
      - waiting 100ms
    72 × waiting for element to be visible and enabled
       - did not find some options
     - retrying select option action
       - waiting 500ms
