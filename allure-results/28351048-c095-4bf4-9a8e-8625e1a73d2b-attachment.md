...
Call log:
  ...
  - retrying click action
    ...
    - scrolling into view if needed
    - done scrolling
    - <input type="password" id="userPassword" name="userPassword" autocomplete="new-password" formcontrolname="userPassword" _ngcontent-ng-cli-universal-c4118926259="" class="form-control ng-untouched ng-dirty ng-valid"/> from <div class="col-md-6" _ngcontent-ng-cli-universal-c4118926259="">…</div> subtree intercepts pointer events
  - retrying click action
    - waiting 20ms
    - waiting for element to be visible, enabled and stable
  ...
  - retrying click action
    ...
    - scrolling into view if needed
    - done scrolling
    - <div class="col-lg-12" _ngcontent-ng-cli-universal-c4118926259="">…</div> intercepts pointer events
  33 × retrying click action
       - waiting 500ms
       - waiting for element to be visible, enabled and stable
       - element is visible, enabled and stable
       - scrolling into view if needed
