...
Call log:
  ...
  - waiting for locator('.ps-4.h6')
    ...
    - locator resolved to <p class="ps-4 h6" _ngcontent-ng-cli-universal-c1674502956="">Total : 42</p>
    - unexpected value "Total : 42"
    227 × locator resolved to <p class="ps-4 h6" _ngcontent-ng-cli-universal-c1674502956="">Total : 24</p>
        - unexpected value "Total : 24"
...
```ts
  ...
  34 |         );
> 35 |         await expect(await userlogin.getTotalcount()).toHaveText('Total : 20');
     |                                                       ^ Error: expect(locator).toHaveText(expected) failed
  36 |     })
  37 | 
  38 | })
