...
```
Error: locator.click: Error: strict mode violation: locator('tr').locator(locator('.fa.fa-trash')) resolved to 2 elements:
    1) <i class="fa fa-trash" _ngcontent-ng-cli-universal-c665162214=""></i> aka getByTitle('Delete').first()
    2) <i class="fa fa-trash" _ngcontent-ng-cli-universal-c665162214=""></i> aka getByTitle('Delete').nth(1)

Call log:
  - waiting for locator('tr').locator(locator('.fa.fa-trash'))
...
```ts
  ...
  19  |         this.deleteBtn = page.locator('.fa.fa-trash');
  20  |     }
  21  | 
