...
Call log:
  ...
  - waiting for locator('//select[@formcontrolname=\'userOrgId\']')
    234 × locator resolved to <select formcontrolname="userOrgId" aria-label="Default select example" _ngcontent-ng-cli-universal-c1859390029="" class="form-control form-select ng-untouched ng-valid ng-dirty">…</select>
