...
- Name: user.spec.js >> test user management page >> check email with invalid data
- Location: tests\user.spec.js:105:10

# Error details

```
Error: locator.click: Unexpected token " " while parsing css selector "button: has-text("Yes")". Did you mean to CSS.escape it?
Call log:
  - waiting for button: has-text("Yes")
