...
Locator:  locator('div span.col-md-2.ng-star-inserted').locator('input')
Expected: 0
Received: 8
Timeout:  120000ms
...
Call log:
  ...
  - waiting for locator('div span.col-md-2.ng-star-inserted').locator('input')
    237 × locator resolved to 8 elements
        - unexpected value "8"
...
> 63 |         await expect(checkRole).toHaveCount(0);
     |                                 ^ Error: expect(locator).toHaveCount(expected) failed
  64 |     })
  65 |     
  66 |     
