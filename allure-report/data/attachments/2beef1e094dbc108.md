...
Call log:
  - waiting for locator('//a[normalize-space()=\'User\']')
    - locator resolved to <a href="/users/list" routerlinkactive="active" _ngcontent-ng-cli-universal-c3077566482="">User</a>
...
```ts
  ...
  31  |         await this.userMgtlink.hover();
  32  |     }
  33  | 
