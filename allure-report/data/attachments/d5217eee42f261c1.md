...
Call log:
  ...
  - waiting for locator('//select[@formcontrolname=\'userTypeId\']')
    237 × locator resolved to <select formcontrolname="userTypeId" _ngcontent-ng-cli-universal-c4118926259="" class="form-control form-select ng-untouched ng-pristine ng-valid">…</select>
